<ul class="nav nav-tabs mb-4">
    <li class="nav-item">
        <a class="nav-link position-relative rounded {{ Request::segment(2) === 'requests' ? 'active' : '' }} text-label"
            aria-current="page" href="{{ route('showRequest') }}"><b><svg xmlns="http://www.w3.org/2000/svg" width="16"
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::segment(2) === 'declined' ? 'active' : '' }} text-label" aria-current="page"
            href="{{ route('showDeclined') }}"><b><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::segment(2) === 'received' ? 'active' : '' }} text-label" aria-current="page"
            href="{{ route('showReceived') }}"><b><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::segment(2) === 'completed' ? 'active' : '' }} text-label" aria-current="page"
            href="{{ route('showCompleted') }}"><b><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
