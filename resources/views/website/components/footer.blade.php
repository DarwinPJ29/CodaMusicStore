<div class="footers">
    ...
    <div class="footer">
        <div class="row">
            ...
            <ul class="row2">
                <li><a class="text-light" href="#"><i class="fa fa-facebook"></i></a></li>
        ...
        <div class="row3">
            <ul>
                <a class="fs-5 text-light" href="#">Contact us</a>
                <a class="fs-5 text-light" href="#">Privacy Policy</a>
                <a class="fs-5 text-light" href="#">Terms & Conditions</a>
            </ul>
        </div>
    ...
    <!-- <hr class="text-light"> -->
        <div class="text-light text-center">
            Copyright Â© 2024. CODA Musical Instrument. All Rights Reserved
        </div>
